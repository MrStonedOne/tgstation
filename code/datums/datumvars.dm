...
/proc/debug_variable(name, value, level, datum/DA = null, sanitize = TRUE)
	...
	if(DA)
		if (istype(DA, /list))
			...
			html += "<li style='backgroundColor:white'>(<a href='?_src_=vars;listremove=\ref[DA];index=[index]'>-</a>) (<a href='?_src_=vars;listedit=\ref[DA];index=[index]'>E</a>) (<a href='?_src_=vars;listchange=\ref[DA];index=[index]'>C</a>) "
		else
