...
/client/verb/linkdiscord()
	...
	if(!stored_id) // Account is not linked
		var/know_how = alert("Do you know how to get a Discord user ID? This ID is NOT your Discord username and numbers! (Pressing NO will open a page to get your discord id, you just need to login to discord.)","Question","Yes","No","Cancel Linking")
		if(know_how == "No")
			src << link("https://tgstation13.org/fetch_discord_userid.php")
